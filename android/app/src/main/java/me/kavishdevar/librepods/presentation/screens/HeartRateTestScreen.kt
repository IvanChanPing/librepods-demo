...
import me.kavishdevar.librepods.presentation.components.HeartRateAnalytics
...
fun HeartRateTestScreen(viewModel: AirPodsViewModel) {
    ...
    Column(
        ...
        HeartRateAnalytics(
            ...
            sessions = state.heartRateSessions,
            onStartSession = viewModel::startNewHeartRateSession,
            onFinishWorkout = viewModel::finishHeartRateWorkout,
            onSetZoneBounds = viewModel::setHeartRateZoneConfig,
        )
