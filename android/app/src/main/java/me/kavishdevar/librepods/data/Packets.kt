...
class AirPodsNotifications {
    companion object {
        private val actionPrefix = BuildConfig.APPLICATION_ID
        val AIRPODS_CONNECTED = "$actionPrefix.AIRPODS_CONNECTED"
        val AIRPODS_L2CAP_CONNECTED = "$actionPrefix.AIRPODS_CONNECTED"
        val AIRPODS_DATA = "$actionPrefix.AIRPODS_DATA"
        val EAR_DETECTION_DATA = "$actionPrefix.EAR_DETECTION_DATA"
        val ANC_DATA = "$actionPrefix.ANC_DATA"
        val BATTERY_DATA = "$actionPrefix.BATTERY_DATA"
        val CA_DATA = "$actionPrefix.CA_DATA"
        val AIRPODS_DISCONNECTED = "$actionPrefix.AIRPODS_DISCONNECTED"
        val AIRPODS_CONNECTION_DETECTED = "$actionPrefix.AIRPODS_CONNECTION_DETECTED"
        val DISCONNECT_RECEIVERS = "$actionPrefix.DISCONNECT_RECEIVERS"
        val EQ_DATA = "$actionPrefix.HEADPHONE_ACCOMMODATION"
        val AIRPODS_INFORMATION_UPDATED = "$actionPrefix.AIRPODS_INFORMATION_UPDATED"
    }
